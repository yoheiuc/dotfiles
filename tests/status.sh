...
cp "${REPO_ROOT}/scripts/lib/claude-plugins.sh" "${fake_repo}/scripts/lib/claude-plugins.sh"
cp "${REPO_ROOT}/scripts/lib/claude-checks.sh" "${fake_repo}/scripts/lib/claude-checks.sh"
